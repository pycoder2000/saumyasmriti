...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    const text = "avinashsuthar19hmh@gmail.com";
            ...
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
              ...
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-3">
                {leftLists.map((item, i) => (
                  <span
                    key={i}
                    className="lg:py-4 lg:px-3 py-2 px-3 text-xs lg:text-md opacity-50 
                    lg:opacity-75 rounded-lg text-center bg-[#10132E]"
                  >
                    {item}
                  </span>
                ))}
